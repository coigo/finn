...
namespace api.Migrations
{
    ...
    [Migration("20250418180907_CategoriaTipoString")]
    partial class CategoriaTipoString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Movimentacoes.Models.MovimentacaoCategoria", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5572),
                        ...
                        {
                            Id = 2,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5609),
                        ...
                        {
                            Id = 3,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5610),
                            Nome = "Investimentos",
                            Tipo = "SAIDA"
                        },
                        new
                        {
                            Id = 4,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5612),
                        ...
                        {
                            Id = 5,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5613),
                            Nome = "Serviços",
                            Tipo = "SAIDA"
                        },
                        new
                        {
                            Id = 6,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5614),
                            Nome = "Moradia",
                            Tipo = "SAIDA"
                        },
                        new
                        {
                            Id = 7,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5615),
                            Nome = "Transporte",
                            Tipo = "SAIDA"
                        },
                        new
                        {
                            Id = 8,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5616),
                            Nome = "Saúde",
                            Tipo = "SAIDA"
                        },
                        new
                        {
                            Id = 9,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5618),
                            Nome = "Salário",
                            Tipo = "ENTRADA"
                        },
                        new
                        {
                            Id = 10,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5619),
                            Nome = "Dividendo",
                            Tipo = "ENTRADA"
                        },
                        new
                        {
                            Id = 11,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5620),
                            Nome = "Venda",
                            Tipo = "ENTRADA"
                        },
                        new
                        {
                            Id = 12,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5621),
                            Nome = "Transferências",
                            Tipo = "ENTRADA"
                        },
                        new
                        {
                            Id = 13,
                            CriadoEm = new DateTime(2025, 4, 18, 14, 9, 7, 456, DateTimeKind.Local).AddTicks(5622),
                            Nome = "Outros",
                            Tipo = "ENTRADA"
                        });
                });
