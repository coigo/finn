...
public class BuscarMovimentacoesUseCase  : IUseCase<BuscarPorPeriodoDTO, List<Movimentacao>> {
    ...
    public async Task<List<Movimentacao>> Execute (BuscarPorPeriodoDTO data) {
        var (inicio, fim) = data;
